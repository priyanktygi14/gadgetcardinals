...
export const PRODUCTS: Product[] = [
  {
    ...
    rating: 4.9,
    reviewsCount: 142,
    image: "/assets/deals/deal-iphone.png",
    cardImage: "/assets/deals/deal-iphone.png",
    galleryImages: [
      "/assets/deals/deal-iphone.png",
      "/assets/hero/iphone-purple-hero.png",
      "/assets/categories/category-iphone.png",
    ],
    colors: [
  ...
  },
  {
    ...
    rating: 4.8,
    reviewsCount: 218,
    image: "/assets/deals/deal-airpods.png",
    cardImage: "/assets/deals/deal-airpods.png",
    galleryImages: [
      "/assets/deals/deal-airpods.png",
      "/assets/hero/airpods-hero.png",
      "/assets/categories/category-airpods.png",
    ],
    colors: [
  ...
  },
  {
    ...
    rating: 4.9,
    reviewsCount: 95,
    image: "/assets/deals/deal-watch.png",
    cardImage: "/assets/deals/deal-watch.png",
    galleryImages: [
      "/assets/deals/deal-watch.png",
      "/assets/hero/watch-hero.png",
      "/assets/categories/category-watch.png",
    ],
    colors: [
  ...
  },
  {
    ...
    cardImage: "/assets/categories/category-macbook.png",
    galleryImages: [
      "/assets/categories/category-macbook.png",
    ],
    colors: [
  ...
  },
  {
    ...
    cardImage: "/assets/categories/category-ipad.png",
    galleryImages: [
      "/assets/categories/category-ipad.png",
    ],
    colors: [
      { name: "Space Gray", hex: "#4A4D52", inStock: true },
      { name: "Silver", hex: "#DCDDE1", inStock: true },
